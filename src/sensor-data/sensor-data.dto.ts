...
export class SensorData {
  ...
  @IsEnum(sensorsEnumSchema.options, { each: true })
...
export class UploadSensorDataRequest extends PickType(SensorData, ['dataName', 'createdAt']) {
  @ApiProperty({ description: 'センサデータID' })
  @IsString()
  @IsOptional()
  readonly id?: SensorDataId;
